export default function Footer1() {
    return (
        <>
            ...
            <footer className="flex flex-col items-center justify-center w-full py-20 bg-gradient-to-r from-green-500 via-green-600 to-green-700  "
     style={{ backgroundImage: "url('/footer.jpg')" }}
            >
             
                <h1 className="text-3xl font-extrabold text-white">Hotel Forest</h1>
                <p className="mt-4 text-center text-white">Copyright © 2025 <a href="https://prebuiltui.com">Hotel Forest</a>. All rights reservered.</p>
